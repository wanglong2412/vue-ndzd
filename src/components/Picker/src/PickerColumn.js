...
import { createNamespace, isObject } from 'vant/es/utils'
...
export default createComponent({
  ...
  methods: {
    ...
    genOptions: function genOptions () {
      ...
      var optionStyle = {
        height: formatPx2Rem(this.itemHeight) + 'rem'
      }
  ...
  render: function render () {
    var h = arguments[0]
    var wrapperStyle = {
      transform: 'translate3d(0, ' + formatPx2Rem(this.offset + this.baseOffset) + 'rem, 0)',
      transitionDuration: this.duration + 'ms',
      transitionProperty: this.duration ? 'all' : 'none',
      lineHeight: formatPx2Rem(this.itemHeight) + 'rem'
    }
    return h('div', {
