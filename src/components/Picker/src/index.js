...
import { BORDER_TOP_BOTTOM, BORDER_UNSET_TOP_BOTTOM } from 'vant/es/utils/constant'
...
export default createComponent({
  ...
  render: function render (h) {
    ...
    var frameStyle = {
      height: formatPx2Rem(itemHeight) + 'rem'
    }
    var columnsStyle = {
      height: formatPx2Rem(wrapHeight) + 'rem'
    }
    var maskStyle = {
      backgroundSize: '100% ' + formatPx2Rem((wrapHeight - itemHeight) / 2) + 'rem'
    }
    return h('div', {
      'class': bem()
