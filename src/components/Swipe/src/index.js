...
import { doubleRaf } from 'vant/es/utils/dom/raf'
import { range } from 'vant/es/utils/format/number' // Mixins
...
export default createComponent({
  ...
  computed: {
    ...
    trackStyle: function trackStyle() {
      ...
      return _ref = {}, _ref[mainAxis] = formatPx2Rem(this.trackSize) + 'rem', _ref[crossAxis] = this[crossAxis] ? formatPx2Rem(this[crossAxis]) + 'rem' : '', _ref.transitionDuration = (this.swiping ? 0 : this.duration) + 'ms', _ref.transform = 'translate' + (this.vertical ? 'Y' : 'X') + '(' + formatPx2Rem(this.offset) + 'rem)', _ref
    },
    ...
    minOffset: function minOffset() {
      ...
      return formatPx2Rem((this.vertical ? this.rect.height : this.rect.width) - this.size * this.count) * htmlFontSize
    }
  },
