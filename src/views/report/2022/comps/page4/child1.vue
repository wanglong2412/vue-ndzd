<template>
  <div class="slide-page page4Son1">
    <div class="cyui-page-wrapper cyui-page4-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page4-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page4-section2-txt2">登录OA<span>12</span>次</div>
          <div class="cyui-page4-section2-txt2">OA在线<span>4380</span>小时</div>
          <div class="cyui-page4-section2-txt2">日均<span>12</span>小时</div>
        </div>
      </transition>
