<template>
  <div class="slide-page page4Son2">
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div v-if="`${current}` === `${sort}`">
          <div class="cyui-page4-section-margin">
            ...
            <div class="cyui-page4-section2-txt2">是收到OA邮件最多的一天</div>
            <div class="cyui-page4-section2-txt2">一共收到<span>25</span>封邮件</div>
          </div>
          <div class="cyui-page4-section-margin">
            <div class="cyui-page4-section2-txt2">相信邮件流动、互动摩擦，能让好想法胜出，把事情做成</div>
          </div>
          <div class="cyui-page4-section-margin">
            <div class="cyui-page4-section2-txt2">你全年收到<span>1049</span>封邮件</div>
            <!-- <div class="cyui-page4-section2-txt2">超过了<span>90%</span>邮件</div> -->
          </div>
        </div>
