<template>
  <div class="slide-page page6Son5">
    <div class="cyui-page-wrapper cyui-page6-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page6-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page6-section2-txt2">你在工作日志</div>
          <div class="cyui-page6-section2-txt2">曾浏览过<span>6</span>篇</div>
          <div class="cyui-page6-section2-txt2">参与互动</div>
          <div class="cyui-page6-section2-txt2"><span style="margin-left: 0">80</span>次（点赞+评论+收藏+转发）</div>
          <div class="cyui-page6-section2-txt2">其中，你最常看的人是<span>江南小微</span></div>
          <div class="cyui-page6-section2-txt2">给他送出了<span>10</span>个赞</div>
          <div class="cyui-page6-section2-txt2">TA一定是最闪耀的星</div>
          <div class="cyui-page6-section2-txt2">才能吸引你不断靠近</div>
        </div>
      </transition>
...
<style lang="less" scoped>
  ...
  // 日志子页面5
  .page6Son5 {
    background-image: url('~@assets/images/report/2022/page6-child5-bg.jpg');
