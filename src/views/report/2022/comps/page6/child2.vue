<template>
  <div class="slide-page page6Son2">
    <div class="cyui-page-wrapper cyui-page6-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page6-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page6-section2-txt2">2022年，你已经发布了<span>12</span>篇文章</div>
          <div class="cyui-page6-section2-txt2">写下了<span>9485356</span>个字</div>
          <div class="cyui-page6-section2-txt2">超过了<span>16%</span>的人</div>
          <div class="cyui-page6-section2-txt2">每个不平凡的日子</div>
          <div class="cyui-page6-section2-txt2">你都在这里留下痕迹</div>
        </div>
      </transition>
...
<style lang="less" scoped>
  ...
  // 日志子页面2
  .page6Son2 {
    background-image: url('~@assets/images/report/2022/page6-child2-bg.jpg');
