<template>
  <div class="slide-page page6Son4">
    <div class="cyui-page-wrapper cyui-page6-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page6-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page6-section2-txt2">2022年</div>
          <div class="cyui-page6-section2-txt2">你的日志光荣上榜<span>6</span>次</div>
          <div class="cyui-page6-section2-txt2">才华横溢的你</div>
          <div class="cyui-page6-section2-txt2">在众多的精英当中</div>
          <div class="cyui-page6-section2-txt2">显得那么卓然不群</div>
          <div class="cyui-page6-section2-txt2">你的才华，无人能及</div>
        </div>
      </transition>
...
<style lang="less" scoped>
  ...
  // 日志子页面4
  .page6Son4 {
    background-image: url('~@assets/images/report/2022/page6-child4-bg.jpg');
