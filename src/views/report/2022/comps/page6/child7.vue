<template>
  <div class="slide-page page6Son7">
    <div class="cyui-page-wrapper cyui-page6-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page6-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page6-section2-txt2">嘘，快来看</div>
          <div class="cyui-page6-section2-txt2">你的财富值达到了<span>8908</span>（积分）</div>
          <div class="cyui-page6-section2-txt2">相信我，再冲把劲</div>
          <div class="cyui-page6-section2-txt2">下一个“福布斯富豪榜”上一定有你的名</div>
        </div>
      </transition>
...
<style lang="less" scoped>
  ...
  // 日志子页面7
  .page6Son7 {
    background-image: url('~@assets/images/report/2022/page6-child7-bg.jpg');
