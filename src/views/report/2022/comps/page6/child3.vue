<template>
  <div class="slide-page page6Son3">
    <div class="cyui-page-wrapper cyui-page6-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page6-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page6-section2-txt2"><span style="margin-left: 0">12</span>月<span>12</span>日</div>
          <div class="cyui-page6-section2-txt2">这大概是很特别的一天</div>
          <div class="cyui-page6-section2-txt2">你文思泉涌</div>
          <div class="cyui-page6-section2-txt2">一口气发了<span>12</span>篇文章</div>
          <div class="cyui-page6-section2-txt2">苦练手速成为指尖上的艺术家</div>
        </div>
      </transition>
...
<style lang="less" scoped>
  ...
  // 日志子页面3
  .page6Son3 {
    background-image: url('~@assets/images/report/2022/page6-child3-bg.jpg');
