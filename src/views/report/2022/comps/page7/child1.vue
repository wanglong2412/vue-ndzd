<template>
  <div class="slide-page page7Son1">
    <div class="cyui-page-wrapper cyui-page7-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page7-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page7-section2-txt2">企业微信获客<span>12</span>个</div>
          <div class="cyui-page7-section2-txt2">连我合伙人数量<span>12</span>个</div>
          <div class="cyui-page7-section2-txt2">每个客户的获取你的都了时间、精 力和心思，还好最终你的努力都不负所望</div>
        </div>
      </transition>
