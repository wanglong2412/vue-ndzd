<template>
  <div class="slide-page page7Son3">
    <div class="cyui-page-wrapper cyui-page7-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page7-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page7-section2-txt2">揽储<span>12</span>名客户</div>
          <div class="cyui-page7-section2-txt2">总计<span>30万</span>元</div>
          <div class="cyui-page7-section2-txt2">最高<span>30万</span>元</div>
          <div class="cyui-page7-section2-txt2">存款余额/比年初</div>
          <div class="cyui-page7-section2-txt2">存款年日均/比年初</div>
          <div class="cyui-page7-section2-txt2">因为你就是你，不一样的烟火， 所以客户才找你</div>
        </div>
      </transition>
