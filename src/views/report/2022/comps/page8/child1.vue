<template>
  <div class="slide-page page8Son1">
    <div class="cyui-page-wrapper cyui-page8-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page8-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page8-section2-txt2">2022年总入职<span>12</span>人</div>
          <div class="cyui-page8-section2-txt2">2022年总离职<span>12</span>人</div>
          <div class="cyui-page8-section2-txt2"><span style="margin-left: 0px">2020</span>年<span>12</span>月<span>25</span>日</div>
          <div class="cyui-page8-section2-txt2">是入职最多的人，**人入职， 那天的你们一定很忙吧</div>
        </div>
      </transition>
