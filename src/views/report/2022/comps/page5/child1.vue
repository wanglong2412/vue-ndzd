<template>
  <div class="slide-page page5Son1">
    <div class="cyui-page-wrapper cyui-page5-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page5-section-margin"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page5-section2-txt2">今年你打开智慧江南<span>12</span>次</div>
          <div class="cyui-page5-section2-txt2">停留了<span>4380</span>小时</div>
          <div class="cyui-page5-section2-txt2">你的每次停留是我们翘首以盼</div>
        </div>
      </transition>
