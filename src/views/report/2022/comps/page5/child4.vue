<template>
  <div class="slide-page page5Son4">
    <div class="cyui-page-wrapper cyui-page5-section2"
      ...
      <transition enter-active-class="animate__animated animate__bounceIn animate__normal"
        ...
        <div class="cyui-page5-list"
             v-if="`${current}` === `${sort}`">
          <div class="cyui-page5-list-title">常用应用访问量</div>

          <div class="cyui-page5-list-item">组织工作</div>
          <div class="cyui-page5-list-item">需求中心</div>
          <div class="cyui-page5-list-item">风控ECC</div>
          <div class="cyui-page5-list-item">知识图谱</div>
          <div class="cyui-page5-list-item">企业年金</div>
          <div class="cyui-page5-list-item">信用卡查询</div>
          <div class="cyui-page5-list-item">党建新闻</div>
          <div class="cyui-page5-list-item">对公视频开户</div>
        </div>
      </transition>
    </div>
    <!--页脚-->
